  ...
  Widget build(BuildContext context) {
    return ListView(
      children: <Widget>[
        ...
        TitleWidget('通过GlobalKey<NavigatorState>保存NavigatorState'),
        RaisedButton(
          onPressed: () {
        ...
        TitleWidget('通过NavigatorObserver保存NavigatorState'),
        RaisedButton(
          onPressed: () {
        ...
        TitleWidget('FullscreenDialog style page'),
        RaisedButton(
          onPressed: () {
            Navigator.push(
              context,
